...
CREATE TABLE `alat` (
  `ime` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
  PRIMARY KEY (`ime`)
...
CREATE TABLE `alatPozicija` (
  `nacrt` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
  `alat` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
  `mjestoNavoja` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
...
CREATE TABLE `materijal` (
  `idMaterijal` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
...
CREATE TABLE `pozicija` (
  `naziv` text CHARACTER SET utf8 COLLATE utf8_croatian_ci,
  `nacrt` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL DEFAULT '0',
  `idMaterijal` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci DEFAULT NULL,
  `redniBr` int DEFAULT NULL,
  `dimenzija` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci DEFAULT NULL,
...
INSERT INTO `pozicija` VALUES ('Klemmbolzen M5','10160936','AISI 304',169,'Ø7',7,1),('Spannbolzen','10160963','AISI 304',162,'Ø7',8,1),('Bolzen M6_25 KRATKI NOVO!','10232608','AISI 316',15,'Ø20',40,1),('Bolzen M6_22 KRATKI NOVO!','10531548','AISI 316',17,'Ø20',35,0),('Bolt  poliranje/novo','10594613','AISI 316',168,'Ø15',20,1),('Priključak plovka (06-11)','108-19-016','AISI 316',170,'Ø12',15,3),('Nut (kvadrat 15 - novo!)','11219725','AISI 304',0,'Ø18',15,2),('Bolzen M8_19,5 KRATKI','11226820','AISI 316',16,'Ø20',35,3),('Stopper screw M6','11263788','AISI 304',71,'SW19',38.5,1),('Hexagon nut M8x1','11331097','AISI 304',138,'SW11',4,1),('Zentrierpin SW8','11344228','AISI 316',75,'Ø10',15,2),('Bolzen M6_18 KRATKI NOVO!','11430378','AISI 316',18,'Ø20',29,0),('Gewindebolzen M6','11460132','AISI 304',113,'Ø12',44,3),('IM-NRV-01: Čep gornji Ø60','IM-NRV-1-3','AISI 316',34,'Ø60',20,4),('IM-NRV-01: Cijev Ø60','IM-NRV-1-4','AISI 316',33,'Ø60x3',84,3),('Dugi bolzeni  6vrsta 304/316','nema','nema',0,'Ø20',75,3);
...
INSERT INTO `pozicijaNarudzba` VALUES ('10160936',2702.2,100),('10160963',2856.4,100),('10232608',0,30),('10531548',2856.3,10),('10594613',2701.2,20),('108-19-016',657,600),('11219725',2618.2,150),('11226820',1,200),('11263788',2702.4,30),('11331097',2921,150),('11344228',2702.3,24),('11430378',2856.1,5),('11460132',2522.7,150),('IM-NRV-1-3',279,300),('IM-NRV-1-4',279,300),('nema',2601,50);
...
CREATE TABLE `tehnologija` (
  `cnc` varchar(100) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL,
  PRIMARY KEY (`cnc`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_croatian_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-26 19:54:20
